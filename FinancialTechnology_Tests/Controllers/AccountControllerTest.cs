...
namespace FinancialTechnology_Test.Repositories
{
    public class AccountControllerTest
    {
        ...
        {
            // Arrange
            var response = new Response<decimal> { IsSuccess = true };
        ...
        {
            // Arrange
            var response = new Response<decimal> { IsSuccess = false };
        ...
        {
            // Arrange
            var response = new Response<decimal> { IsSuccess = true, Data = 100 };
